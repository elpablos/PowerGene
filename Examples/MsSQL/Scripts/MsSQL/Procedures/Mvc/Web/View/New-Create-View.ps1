...
Add-Line('@{')
Add-Line('  ViewBag.Title = $"Založení záznamu";' -f $data.Metadata.Modules, $data.Metadata.PluralName,$data.Metadata.Prefix, $data.Metadata.Name, $data.Metadata.ProcedureDescription, $data.Metadata.AppNamespace)
Add-Line('}');
Add-Line('')
...
Add-Line('  <div>')
Add-Line('    <h1><i class="fa fa-money"></i> Založení záznamu</h1>')
...
Add-Line('    <li class="breadcrumb-item">@Html.ActionLink("Pøehled", "Index")</li>')
Add-Line('    <li class="breadcrumb-item"><a href="@Url.Action()">Založení záznamu</a></li>')
Add-Line('  </ul>')
Add-Line('</div>')
...
Add-Line('          }')
Add-Line('          <a class="btn btn-secondary" href="@Url.Action("Index")"><i class="fa fa-fw fa-lg fa-times-circle"></i>Zpìt</a>')
Add-Line('        </div>')
