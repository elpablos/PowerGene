...
Add-Line('  <div>')
Add-Line('    <h1><i class="fa fa-money"></i> Úprava záznamu</h1>')
Add-Line('    <p>Všechny podrobnosti o danén záznamu</p>')
Add-Line('  </div>')
...
Add-Line('    <li class="breadcrumb-item"><a href="@Url.Action()">Úprava záznamu</a></li>')
Add-Line('  </ul>')
Add-Line('</div>')
...
Add-Line('          }')
Add-Line('          <a class="btn btn-secondary" href="@Url.Action("Detail", routeValues: new { id = Model.Id })"><i class="fa fa-fw fa-lg fa-times-circle"></i>Zpìt</a>')
Add-Line('        </div>')
