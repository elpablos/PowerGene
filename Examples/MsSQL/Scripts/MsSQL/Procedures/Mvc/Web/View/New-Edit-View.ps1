...
Add-Line('@{')
Add-Line('  ViewBag.Title = $"{{{5}.Resources.Dictionary.{0}_{3}}} {{Model.DisplayName}}";' -f $data.Metadata.Modules, $data.Metadata.PluralName,$data.Metadata.Prefix, $data.Metadata.Name, $data.Metadata.ProcedureDescription, $data.Metadata.AppNamespace)
Add-Line('}');
Add-Line('')
...
Add-Line('                @if (Html.HasAction("{0}_DEL"))' -f $table)
Add-Line('                {')
Add-Line('                  <hr />')
Add-Line('                  <div class="form-group row">')
Add-Line('                    <label class="col-md-3 col-lg-2 col-form-label">')
Add-Line('                      @{2}.Resources.Dictionary.{0}_{1}' -f $data.Metadata.Modules, $data.Metadata.Name, $data.Metadata.AppNamespace)
Add-Line('                    </label>')
Add-Line('                    <div class="col-md-3 col-lg-3">')
Add-Line('                      @Html.ActionLink({1}.Resources.Dictionary.Core_Delete, "Delete", "{0}", new {{ Id = Model.Id }}, new {{ @class = "btn btn-danger" }})' -f $data.Metadata.Name, $data.Metadata.AppNamespace)
Add-Line('                    </div>')
Add-Line('                  </div>')
Add-Line('                }')
Add-Line('')
